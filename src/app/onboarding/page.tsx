        ...
        <section className="space-y-4 border-t border-neutral-950 pt-6">
          ...
          <label className="block space-y-1.5">
            ...
            <input
              ...
              className="block w-full cursor-pointer border border-neutral-300 bg-white text-sm text-neutral-500 file:mr-3 file:cursor-pointer file:border-0 file:bg-neutral-950 file:px-4 file:py-2.5 file:font-mono file:text-[11px] file:tracking-[0.14em] file:text-white"
            />
          </label>
          <p className="text-center font-mono text-[10px] tracking-[0.22em] text-neutral-400">
            — OR —
          </p>
          <label className="block space-y-1.5">
